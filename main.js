...
async function getProfileFromCeramic() {
    ...
    function renderProfileData(data) {
        if (!data) return
        data.name ? profileName.innerHTML = "Name of Authority:     " + data.name : profileName.innerHTML = "Name of Authority:     "
        data.gender ? profileGender.innerHTML = "Description of report:     " + data.gender : profileGender.innerHTML = "Description of report:     "
        data.country ? profileCountry.innerHTML = "Authority ID number:     " + data.country : profileCountry.innerHTML = "Authority ID number:     "
    }
    ...
    walletBtn.innerHTML = "Connect Wallet"
    profileName.innerHTML = "Name of Authority: "
    profileGender.innerHTML = "Description of report: "
    profileCountry.innerHTML = "Authority ID number:: "
